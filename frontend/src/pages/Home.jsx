        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-4xl mx-auto text-gray-700 leading-relaxed space-y-4">
            <p>
              ...
              to crafting unforgettable travel experiences across both domestic
              and international destinations. Renowned for its reliability,
              transparency, and meticulous attention to detail, Abhimanyu
              Holidays is a trusted partner for travelers seeking seamless and
              memorable vacations.
            </p>
            <p>
              With a strong commitment to customer satisfaction, the company
              offers a comprehensive suite of services, including customized
              tour packages, flight and hotel bookings, and expertly guided
              tours. One of the key strengths of Abhimanyu Holidays is its
              personalized approach to travel planning. Every itinerary is
              thoughtfully designed to reflect the client's preferences, budget,
              and travel aspirations — whether it's a romantic getaway, a family
              vacation, or a corporate retreat.
            </p>
            <p>
              Backed by a team of experienced travel professionals and a robust
              global network of partners, Abhimanyu Holidays continues to expand
              its footprint in the travel industry, delivering exceptional
              service and creating journeys that leave lasting impressions.
            </p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600">
              Premium accommodations showcasing Rajasthan's royal hospitality
              and modern comforts
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
